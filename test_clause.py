...
class TestClause(unittest.TestCase):
  ...
  def test_assign(self: TestClause):
    ...
    clause.assign(a1, 0)
    self.assertEqual(clause.get_state(a1, 0), (Clause.UNRESOLVED, 5, 1))
    ...
    clause.assign(a1, 2)
    self.assertEqual(clause.get_state(a1, 2), (Clause.UNRESOLVED, 3, 2))
  ...
  def test_valid_1(self: TestClause):
    ...
    clause.assign(a1, 2)
    self.assertEqual(clause.get_state(a1, 2), (Clause.SATISFIED, 3, 2))
  ...
  def test_valid_2(self: TestClause):
    ...
    a1.add_assignment(2, 2, 0, None)
    clause.assign(a1, 2)
    self.assertEqual(clause.get_state(a1, 2), (Clause.SATISFIED, 2, 2))
  ...
  def test_unit(self: TestClause):
    ...
    a1.add_assignment(2, 1, 0, None)
    clause.assign(a1, 2)
    self.assertEqual(clause.get_state(a1, 2), (Clause.UNIT, 2, 2))
  ...
  def test_unsat(self: TestClause):
    ...
    clause.assign(a1, 2)
    self.assertEqual(clause.get_state(a1, 2), (Clause.UNSATISFIED, 1, 1))
    self.assertEqual(clause.get_assigned_vars(a1), [6, 5, 4, 3, 2, 1])
  ...
  def test_backtrack(self: TestClause):
    ...
    clause.backtrack(1)
    a1.backtrack(1)
    self.assertEqual(clause.get_state(a1, 1), (Clause.UNRESOLVED, 2, 1))
    self.assertEqual(clause.get_assigned_vars(a1), [6, 5, 4, 3])
    clause.backtrack(0)
    a1.backtrack(0)
    self.assertEqual(clause.get_state(a1, 0), (Clause.UNRESOLVED, 6, 1))
